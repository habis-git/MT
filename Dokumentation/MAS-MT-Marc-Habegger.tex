...
\label{Sicherheit}
Die Sicherheit von \Gls{ML} Modellen ist durch verschiedene Angriffsmethoden gefährdet. In der Regel geht man für Sicherheitsüberlegungen von einem \Gls{Black Box} Modell aus, da ein Angreifer das Modell in der Anwendung (d.h. nach der Erzeugung) angreift.
\begin{description}
...
Nach Seong Joon Oh \parencite{Oh2019} hat Art des Modells von grossen Einfluss auf die Möglichkeiten der Erklärbarkeit. Generell wird unterschieden zwischen
\begin{description}
...
\parag{Verfahren für globale Erklärungen}
\begin{itemize}
...
\parag{Verfahren für lokale Erklärungen}
\begin{itemize}
...
\begin{tabular}{@{} *5l @{}}    \toprule
	...
	k-nearest neighbors & Nein & Nein & klass.,regr. \\ \bottomrule
	 \hline
\end{tabular}
\captionof{table}{Entscheidungstabelle Erklärbare Modelle}
\captionof*{table}{Quelle: \parencite{iML}}
\end{table}
...
\end{lstlisting}
\captionof{figure}{scope-rules Ausgabe der Regeln}
\captionof*{figure}{Quelle: \url{https://skope-rules.readthedocs.io/}}
\end{minipage}
...
\section{Schwer erklärbare Modelle}
...
\begin{minipage}[t]{\linewidth}
 	\includegraphics[width=\textwidth]{Bilder/svcca-similarities.png}
    	\captionof{figure}{Vergleich Verschiedener Klassen mit SVCCA}
    	\captionof*{figure}{Quelle: Google AI Blog, Interpreting Deep Neural Networks with SVCCA}
\end{minipage}
\end{center}
\cite{svccaLink}
...
\captionof{figure}{Klassifizierung eines Pferdes in Pascal VOC}
\captionof*{figure}{Quelle: Unmasking Clever Hans Predictors and Assessing What Machines Really Learn \cite{Lapuschkin2019}}
\end{minipage}\hfill
\begin{minipage}[t]{0.45\linewidth}
\vspace{20pt}
...
\begin{minipage}[t]{0.45\linewidth}
	...
	\includegraphics[width=0.9\textwidth]{Bilder/tensorflow-adversarial-original.png}
	 \captionof{figure}{Ursprungs-Bild}
	\captionof*{figure}{Quelle: \parencite{tensorflowFGSM}}
\end{minipage}\hfill
\begin{minipage}[t]{0.45\linewidth}
	\vspace{0pt}
	\centering
...
\begin{minipage}[t]{0.45\linewidth}
	...
	\includegraphics[width=0.9\textwidth]{Bilder/speed-limit-fake-small.png}
	 \captionof{figure}{Gefälschtes Verkehrsschild als Adversarial Attack}
	\captionof*{figure}{Quelle: \parencite{advTesla}}
\end{minipage}\hfill
\begin{minipage}[t]{0.45\linewidth}
	\vspace{0pt}
