...
Allerdings gelten auch Whitebox Modelle mit vielen Parametern als schwer erklärbar. Es ist möglich einen Entscheidungsbaum (\Gls{DT}) mit 10'000 Eingangsparametern zu trainieren welcher dreistellige Tiefen erreichen kann. In diesem Fällen verwischt die Grenze zwischen White- und Blackbox.
