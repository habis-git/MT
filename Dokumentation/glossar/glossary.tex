...
{
	name=White Box,
	description={System über welches man Kenntnisse der inneren Funktionsweise hat. In der Regel ist der Sourcecode des Systems verfügbar und kann für die Analyse verwendet werden.}                                   
}     
